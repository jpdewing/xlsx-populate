    ...
    _init(node) {
        ...
        if (this._imageRelationship) {
            if (this._imageRelationship.attributes.Type.toString().includes('/image')) {
                ...
                this._svgId = node.children[2].children[1].children[0].children[0].children[0].children[0].attributes['r:embed'];
                ...
                this._svgPath = this._svgRelationship.attributes.Target;
